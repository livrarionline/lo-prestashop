...
{*    <p class="smart_lockers_desc">{l s='You don\'t have to meet with courier again, you can pick up your products from a smart locker.' mod='lo'}</p>*}
    ...
    <p class="smart_lockers_selected"
       {if !isset($selected_locker_name) || !$selected_locker_name}style="display: none;"{/if}>{l s='Selected locker:' mod='lo'}
        <span>{if isset($selected_locker_name) && $selected_locker_name}{$id_locker} - {$selected_locker_name|escape:'htmlall':'UTF-8'}{/if}</span>
    </p>
    <div id="lockers_container" style="display: none;">
        <div class="lockers_form">
            <div class="form-group">
                <select name="lo_state" id="lo_state" class="form-control" style="width: 200px">
            ...
            <div class="form-group">
                <select name="lo_city" id="lo_city" class="form-control" style="width: 200px">
                    <option value="0">{l s='Choose a city' mod='lo'}</option>
                </select>
            </div>
            <div class="form-group">
                <select name="lo_locker" id="lo_locker" class="form-control" style="width: 200px">
